 ...
 *
 * Each run of /impeccable-flutter critique writes a per-target snapshot to
 *   .impeccable-flutter/critique/<timestamp>__<slug>.md
 * with a small YAML frontmatter carrying the score + P0/P1 counts.
 *
 * /impeccable-flutter polish reads the latest matching snapshot at start as its
...
import { getCritiqueDir } from './impeccable-flutter-paths.mjs';
