...
```bash
node .qoder/skills/impeccable-flutter/scripts/live.mjs
```
...
```
LOOP:
  node .qoder/skills/impeccable-flutter/scripts/live-poll.mjs   # default long timeout; no --timeout=
...
```bash
node .qoder/skills/impeccable-flutter/scripts/live-status.mjs
node .qoder/skills/impeccable-flutter/scripts/live-resume.mjs --id SESSION_ID
node .qoder/skills/impeccable-flutter/scripts/live-complete.mjs --id SESSION_ID
```
...
```bash
node .qoder/skills/impeccable-flutter/scripts/live-wrap.mjs --id EVENT_ID --count EVENT_COUNT --element-id "ELEMENT_ID" --classes "class1,class2" --tag "div" --text "TEXT_SNIPPET"
```
...
```bash
node .qoder/skills/impeccable-flutter/scripts/live-poll.mjs --reply EVENT_ID done --file RELATIVE_PATH
```
...
```bash
node .qoder/skills/impeccable-flutter/scripts/live-poll.mjs --reply EVENT_ID error "Short reason"
```
...
```bash
node .qoder/skills/impeccable-flutter/scripts/live-server.mjs stop
```
...
```bash
node .qoder/skills/impeccable-flutter/scripts/detect-csp.mjs
```
