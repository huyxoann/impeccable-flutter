...
export const IMPECCABLE_DIR = '.impeccable-flutter';
...
export function getLegacyLiveServerPath(cwd = process.cwd()) {
  return path.join(cwd, '.impeccable-flutter-live.json');
}
...
export function getLegacyLiveSessionsDir(cwd = process.cwd()) {
  return path.join(cwd, '.impeccable-flutter-live', 'sessions');
}
...
export function getLegacyLiveAnnotationsDir(cwd = process.cwd()) {
  return path.join(cwd, '.impeccable-flutter-live', 'annotations');
}
