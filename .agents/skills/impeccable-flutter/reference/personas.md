...
If `AGENTS.md` contains a `## Design Context` section (generated by `impeccable-flutter teach`), derive 1–2 additional personas from the audience and brand information:
